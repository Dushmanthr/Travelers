...
const Hero = () => {
  return (
    <div className='relative w-[100%] h-[88vh]'>
      ...
      <video src="/Images/hero1.mp4" autoPlay muted loop preload="metadata" className='w-[100%] h-[100%] object-cover'/>
      <div className='absolute z-[100] w-[100%] h-[100%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        <div className="flex items-center justify-center flex-col w-[100%] h-[100%]">
          <div>
            <h1 className='text-[25px] mb-[1rem] md:mb-[0] text-center md:text-[35px] lg:text-[45px] tracking-[0.2rem] text-white font-bold uppercase'>Let's Enjoy the journey</h1>
          ...
          <SearchBox/>
          <a href="#_" className='rounded px-14 md:px-28 mt-[-1rem] py-2.5 overflow-hidden group bg-red-500 relative hover:bg-gradient-to-r hover: from-red-500 hover:to-red-400 text-white hover:ring-2 hover:ring-offset-2 hover: ring-red-400 transition-all ease-out duration-300'>
