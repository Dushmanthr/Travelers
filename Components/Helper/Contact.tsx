  ...
  return (
    <div className='pt-[8rem] pb-[3rem]'>
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
        ...
        <div data-aos="fade-left" daya-aos-delay = "800" className='flex items-center justify-center flex-col'>
          ...
          <p className='mt-[0.7rem] w-[80%] xl:[60%] mx-auto text-center text-[15px] text-black opacity-70 '>Subscribe to see the secret deals prices drop the moment you sign up{" "}</p>
          <div className='flex mt-[1.4rem] rounded-lg bg-gray-300 mb-[3rem] items-center space-x-2 w-[80%] h-[4vh] md:h-[6.3vh] '>
            <input  className="ml-[1rem] bg-transparent w-[80%] h-[100%] border-none outline-none "  type="email" placeholder='Email address'/>
